...
- **maskingpatheq:** *Masking Path Function*

  `"maskingpatheq" : "getFBF()#0,60,150:(0,416)-(0,0)-(0,0)/(0,416)-(0,416)-(0,416)/(0,416)-(416,416)-(416,416)/(416,0)-(416,416)-(416,416)/(416,0)-(416,0)-(416,0)/(416,0)-(0,0)-(0,0)"`
...
- **maskbordercolor:** *maskbordercolor is used to set border color of mask `Default:null`*
...
- **maskshadowcolor:** *maskshadowcolor is used to set shadow color of mask `Default: null`*
